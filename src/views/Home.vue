<template>
  <div>
    <HeaderComponent/>
    <v-carousel hide-controls hide-delimiters height="200">
      <v-carousel-item v-for="(item,i) in items" :key="i" :src="item.src"></v-carousel-item>
    </v-carousel>
    <v-card class="red darken-4">
      <marquee class="white--text">1,尊敬的客户：您好，大额支付建议您使用银行卡入款，笔笔可享最高1.5%优惠！详情可咨询在线客服哦.2,特别通告：【电子】【棋牌】【捕鱼】全新返水升级，全网最劲爆的游戏平台尽在澳门威尼斯人。</marquee>
    </v-card>
    <v-card class="orange mt-3">
      <v-layout row wrap>
        <v-layout xs12 class="pt-4">
          <v-flex xs10>
            <span class="pr-4">平台推荐</span>
            <span>精彩荟萃,激情无限</span>
          </v-flex>
          <v-flex xs2>
            更多
    ...
    <v-card class="orange mt-3 mb-3">
      <v-layout row wrap>
        <v-layout xs12 class="pt-4">
          <v-flex xs10>
            <span class="pr-4">精选大促</span>
            <span>各种优惠为您撑腰</span>
          </v-flex>
          <v-flex xs2>
            更多
      ...
      <v-layout xs12 class="pt-4">
        <v-flex xs6>
          <img src="@/assets/2.jpg" height="200" width="200" class="px-2">
        </v-flex>
        <v-flex xs6>
      <v-layout xs12>
          <img src="@/assets/1.png" height="100" width="180" class="px-2">
        
      </v-layout>      
      <v-layout xs12>
          <img src="@/assets/3.jpg" height="100" width="180" class="px-2">      
      </v-layout>    
        </v-flex>
      </v-layout>
    </v-card>
